    ...
    GooseAttack::initialize()?
        .register_taskset(
            taskset!("LoadtestTasks")
                .register_task(task!(setup_custom_client).set_on_start())
                .register_task(task!(loadtest_python))
                .register_task(task!(loadtest_js))
                // .register_task(task!(loadtest_rust))
                .register_task(task!(loadtest_go)),
        )
